---
title: "AI Law Required"
slug: ai-law-required
metaDescription: "AI Law Required in India as per Ashwini Vaishnaw, IT Act era is different from AI world, new law is needed to regulate AI"
excerpt: "India needs a new AI law to regulate AI, as the current IT Act is insufficient, says Ashwini Vaishnaw"
category: AI
date: 2026-06-10
...
- q: "How will a new AI law impact Indian businesses?"
  a: "A new AI law will provide clarity and certainty for Indian businesses, allowing them to invest in AI with confidence. We've worked with numerous businesses in India, and we believe that a well-crafted AI law will help them navigate the complexities of AI and unlock its full potential."
...
* Data protection: AI systems rely on large amounts of data, and a new AI law should ensure that this data is protected and used responsibly.
* Algorithmic transparency: AI systems use complex algorithms to make decisions, and a new AI law should ensure that these algorithms are transparent and explainable.
* Accountability: AI systems can have significant impacts on individuals and society, and a new AI law should ensure that those responsible for AI systems are held accountable for their actions.
...
## The Role of Blockchain in AI Regulation
Blockchain technology can play a crucial role in ensuring the integrity and transparency of AI systems. Blockchain can be used to create a secure and transparent record of AI decision-making, ensuring that AI systems are accountable and trustworthy. Our team has expertise in blockchain consulting, and we believe that blockchain can help to build trust in AI systems.
...
As the Indian government moves forward with the development of a new AI law, it is essential that businesses stay informed and engaged. We will continue to monitor developments and provide updates and insights to help Indian businesses prepare for the changing AI landscape. For more information on AI and its impact on Indian businesses, visit [NASSCOM](https://www.nasscom.in/) or [MeitY](https://www.meity.gov.in/).

## Sources
* [inc42.com](https://inc42.com/buzz/ai-world-very-different-from-it-act-era-new-law-required-ashwini-vaishnaw/)
* [India AI](https://indiaai.gov.in/)
* [DPDP](https://www.dpdp.gov.in/)
