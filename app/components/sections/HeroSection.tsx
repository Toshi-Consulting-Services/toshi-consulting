    ...
    <div className="relative w-full max-w-[460px] aspect-square mx-auto select-none">
      ...
      <div className="absolute inset-0 grid place-items-center">
        {[0, 0.6, 1.2, 1.8].map((delay, i) => (
          <span
            key={i}
            className="absolute rounded-full border-2 border-blue-400/40 animate-radar"
            style={{
              width: '78%',
              height: '78%',
      ...
      <div className="absolute left-[2%] bottom-[18%] bg-white rounded-2xl shadow-[0_18px_45px_-14px_rgba(0,114,153,0.3)] border border-blue-100 px-4 py-3 flex items-center gap-3 animate-float -rotate-2" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="leading-tight">
          ...
          <div className="text-[10px] text-blue-600 font-semibold flex items-center gap-1">
            <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" /> Available 24/7
          </div>
        </div>
      </div>
      ...
      <div className="absolute right-[2%] top-[14%] bg-white rounded-2xl shadow-[0_18px_45px_-14px_rgba(0,114,153,0.3)] border border-blue-100 px-3 py-2 flex items-center gap-2 animate-float rotate-3" style={{ animationDelay: '1.2s' }}>
        ...
        <div className="text-[11px] font-bold text-slate-900 leading-tight">
          AI-Native
          <div className="text-blue-600 text-[10px] font-semibold">Automation-first</div>
        </div>
      </div>
    </div>
  );
    ...
    <section className="relative overflow-hidden hero-bg pt-32 pb-20 lg:pb-28">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-2 max-w-xl animate-fade-up lg:pl-4">
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur border border-blue-200 text-blue-700 rounded-full px-4 py-1.5 text-xs font-bold tracking-wide uppercase shadow-sm">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              href="/services"
              className="inline-flex items-center gap-2 bg-white border-2 border-blue-600 text-blue-700 px-7 py-3.5 rounded-full font-bold hover:bg-blue-50 transition"
            >
              Our Services
            </Link>
          </div>
          ...
          <div className="mt-8 flex flex-wrap gap-2">
            {[
              ...
              <span
                key={p.label}
                className="inline-flex items-center gap-1.5 bg-white border border-blue-200 text-slate-700 px-3.5 py-1.5 rounded-full text-xs font-semibold shadow-sm"
              >
