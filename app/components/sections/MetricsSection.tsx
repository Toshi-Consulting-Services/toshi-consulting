...
const metrics = [
  { number: 100, suffix: '%',     label: 'Delivery Commitment',     icon: CheckCircle2, tone: 'from-blue-500 to-blue-500' },
  { number: 99,  suffix: '%',     label: 'Project Success Rate',    icon: TrendingUp,   tone: 'from-cyan-500 to-blue-500' },
  { number: 24,  suffix: '/7',    label: 'Round-the-Clock Support', icon: Headphones,   tone: 'from-violet-600 to-cyan-500' },
  { number: 10,  suffix: '+',     label: 'Years of Excellence',     icon: Award,        tone: 'from-blue-500 to-blue-600' },
];
