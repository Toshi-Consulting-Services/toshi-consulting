...
export default function TestimonialsSection() {
  return (
    <section className="relative py-24 section-mint overflow-hidden">
      <div className="pointer-events-none absolute top-20 right-10 w-80 h-80 rounded-full bg-blue-200/30 blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <Reveal className="text-center max-w-2xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 bg-white border border-blue-200 text-blue-700 rounded-full px-4 py-1.5 text-xs font-bold tracking-wide uppercase shadow-sm">
            <Star size={13} className="text-blue-600 fill-blue-500" /> Client Stories
          </div>
            ...
            <Reveal key={t.name} delay={i * 120}>
              <article className="group h-full flex flex-col bg-white rounded-3xl p-8 border border-blue-100 shadow-[0_15px_45px_-25px_rgba(0,114,153,0.4)] hover:-translate-y-1 hover:shadow-[0_25px_55px_-25px_rgba(0,114,153,0.55)] transition">
                ...
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-9 h-9 text-blue-200 mb-4"
                  aria-hidden="true"
                >
