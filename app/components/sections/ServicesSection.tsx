...
export default function ServicesSection() {
  ...
  return (
    <section className="relative py-24 section-mint overflow-hidden">
      ...
      <div className="pointer-events-none absolute top-20 right-10 w-72 h-72 rounded-full bg-blue-200/30 blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <Reveal className="text-center max-w-2xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 bg-white border border-blue-200 text-blue-700 rounded-full px-4 py-1.5 text-xs font-bold tracking-wide uppercase shadow-sm">
            <span className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Our Services
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <Reveal className="lg:col-span-2 lg:row-span-2">
            <Link
              ...
              className="group relative block h-full bg-white rounded-3xl p-8 border border-blue-100 shadow-[0_15px_45px_-25px_rgba(0,114,153,0.45)] hover:shadow-[0_25px_55px_-22px_rgba(0,114,153,0.55)] hover:-translate-y-1 transition overflow-hidden"
            >
              ...
              <div className="absolute right-6 bottom-6 hidden md:block opacity-90">
                <div className="w-72 h-44 rounded-2xl bg-white border border-blue-100 shadow-[0_25px_50px_-20px_rgba(0,114,153,0.45)] p-4 rotate-3 group-hover:rotate-2 transition">
              ...
              <div className="relative max-w-sm">
                <div className="inline-flex items-center gap-1.5 bg-blue-50 border border-blue-200 text-blue-700 rounded-full px-3 py-1 text-[11px] font-bold uppercase tracking-wider">
                  <Sparkles size={12} /> Most requested
                </div>
                <div className={`mt-5 inline-grid place-items-center w-16 h-16 rounded-2xl bg-gradient-to-br ${featured.tone} text-white shadow-[0_18px_35px_-12px_rgba(0,152,204,0.65)] group-hover:scale-110 transition`}>
                ...
                <div className="mt-6 inline-flex items-center gap-1.5 text-blue-700 font-bold">
            ...
            return (
              <Reveal key={s.slug} delay={(i + 1) * 90}>
                <Link
                  ...
                  className="group relative block bg-white rounded-3xl p-6 border border-blue-100 shadow-[0_10px_30px_-20px_rgba(0,114,153,0.4)] hover:shadow-[0_22px_44px_-22px_rgba(0,114,153,0.55)] hover:-translate-y-1 transition overflow-hidden h-full"
                >
                  ...
                  <div className="relative">
                    <div className={`inline-grid place-items-center w-12 h-12 rounded-2xl bg-gradient-to-br ${s.tone} text-white shadow-[0_15px_30px_-12px_rgba(0,152,204,0.6)] group-hover:scale-110 transition`}>
                      <Icon size={22} />
                    </div>
                    ...
                    <div className="mt-4 inline-flex items-center gap-1.5 text-blue-700 text-sm font-bold">
                      View details
                      <ArrowUpRight
                        size={14}
                        className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition"
        ...
        <Reveal className="mt-10 text-center">
          <Link
            href="/services"
            className="inline-flex items-center gap-2 bg-white border border-blue-200 text-blue-700 px-6 py-3 rounded-full text-sm font-bold hover:bg-blue-50 hover:-translate-y-0.5 shadow-sm transition"
          >
            View all services
