        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <Reveal className="lg:col-span-2 lg:row-span-2">
            <Link
              ...
              className="group relative block h-full bg-white rounded-3xl p-8 border border-blue-100 shadow-[0_15px_45px_-25px_rgba(0,71,212,0.45)] hover:shadow-[0_25px_55px_-22px_rgba(0,71,212,0.55)] hover:-translate-y-1 transition overflow-hidden"
            >
              ...
              <div className="absolute right-6 bottom-6 hidden md:block opacity-90">
                <div className="w-72 h-44 rounded-2xl bg-white border border-blue-100 shadow-[0_25px_50px_-20px_rgba(0,71,212,0.45)] p-4 rotate-3 group-hover:rotate-2 transition">
              ...
              <div className="relative max-w-sm">
                ...
                <div className={`mt-5 inline-grid place-items-center w-16 h-16 rounded-2xl bg-gradient-to-br ${featured.tone} text-white shadow-[0_18px_35px_-12px_rgba(0,101,248,0.65)] group-hover:scale-110 transition`}>
            ...
            return (
              <Reveal key={s.slug} delay={(i + 1) * 90}>
                <Link
                  ...
                  className="group relative block bg-white rounded-3xl p-6 border border-blue-100 shadow-[0_10px_30px_-20px_rgba(0,71,212,0.4)] hover:shadow-[0_22px_44px_-22px_rgba(0,71,212,0.55)] hover:-translate-y-1 transition overflow-hidden h-full"
                >
                  ...
                  <div className="relative">
                    <div className={`inline-grid place-items-center w-12 h-12 rounded-2xl bg-gradient-to-br ${s.tone} text-white shadow-[0_15px_30px_-12px_rgba(0,101,248,0.6)] group-hover:scale-110 transition`}>
                      <Icon size={22} />
                    </div>
