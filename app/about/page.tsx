      ...
      <main className="flex-1">
        ...
        <section className="py-24 section-mint">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8">
            <div className="relative bg-white rounded-3xl p-10 border border-teal-100 shadow-[0_15px_45px_-25px_rgba(15,118,110,0.4)] overflow-hidden">
            ...
            <div className="relative bg-gradient-to-br from-teal-600 to-cyan-600 text-white rounded-3xl p-10 shadow-[0_25px_60px_-25px_rgba(15,118,110,0.6)] overflow-hidden">
