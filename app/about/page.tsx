      ...
      <main className="flex-1">
        ...
        <section className="py-24 section-mint">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8">
            <div className="relative bg-white rounded-3xl p-10 border border-blue-100 shadow-[0_15px_45px_-25px_rgba(0,114,153,0.4)] overflow-hidden">
              <div className="absolute -top-16 -right-16 w-56 h-56 rounded-full bg-blue-100/60 blur-2xl" />
              <div className="relative">
                <div className="inline-grid place-items-center w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 text-white shadow-[0_15px_30px_-12px_rgba(0,152,204,0.6)]">
                  <Target size={26} />
                </div>
            ...
            <div className="relative bg-gradient-to-br from-violet-600 to-cyan-500 text-white rounded-3xl p-10 shadow-[0_25px_60px_-25px_rgba(0,114,153,0.6)] overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((v) => {
                const Icon = v.icon;
                return (
                  <div key={v.title} className="group bg-white rounded-2xl p-7 border border-blue-100 shadow-[0_10px_30px_-20px_rgba(0,114,153,0.4)] hover:-translate-y-1 hover:shadow-[0_22px_44px_-22px_rgba(0,114,153,0.5)] transition">
                    <div className="inline-grid place-items-center w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 text-white shadow-[0_12px_25px_-10px_rgba(0,152,204,0.6)] group-hover:scale-110 transition">
                      <Icon size={22} />
                    </div>
